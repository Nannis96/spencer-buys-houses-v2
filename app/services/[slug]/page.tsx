...
export async function generateMetadata(
    ...
    if (!service) {
        return { title: 'Service Not Found | Spencer Buys Houses' };
    }

    return {
        title: `${service.seoTitle || service.title} | Spencer Buys Houses`,
        description: service.seoDesc || undefined,
        keywords: service.focusKeyword || undefined,
        openGraph: {
