...
export default function EditServiceForm({ service }: { service: ServiceData }) {
    const [mainImageFiles, setMainImageFiles] = useState<ImageFile[]>(
        service.mainImage ? [{ url: service.mainImage }] : []
    );
    const [authorImageFiles, setAuthorImageFiles] = useState<ImageFile[]>(
        service.authorImage ? [{ url: service.authorImage }] : []
    );
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="category" defaultValue={service.category} className={fieldCls}>
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            name="focusKeyword"
                            defaultValue={service.focusKeyword || ''}
                            className={fieldCls}
                        />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                type="text"
                                name="authorName"
                                defaultValue={service.authorName || ''}
                    ...
                    <div>
                        ...
                        <textarea
                            name="authorBio"
                            rows={5}
                            defaultValue={service.authorBio || ''}
