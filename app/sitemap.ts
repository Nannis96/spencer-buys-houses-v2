...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    const staticRoutes: MetadataRoute.Sitemap = [
        ...
        { url: `${BASE_URL}/property-details`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
        { url: `${BASE_URL}/property-info`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
